...
//	public static final ObjectiveType NPC_FOLLOW = new ObjectiveType("Follow an NPC", "npc_follow", HoconObjectiveNPCFollow.class);
	...
	public static final ObjectiveType POEM = new ObjectiveType("Poem Puzzle", "poem", ObjectivePoem.class);
	public static final ObjectiveType MONEY = new ObjectiveType("Gather Money", "money", ObjectiveMoney.class);
